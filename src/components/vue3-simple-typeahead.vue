    ...
    <div v-if="isListVisible" class="simple-typeahead-list">
      ...
      <div
        ...
        :class="{
          ...
          'history-list': index < intersection,
        }"
...
export default /*#__PURE__*/ defineComponent({
  ...
  methods: {
    ...
    changeIntersection(){
      this.intersection = this.intersectionNumberOfFilteredItemAndLocallist;
    },    
  },
  computed: {
    wrapperId() {
    ...
    intersectionNumberOfFilteredItemAndLocallist(){
      let temp = this.filteredItems.filter(x => this.localStorageList.includes(x)); 
      return temp.length;
    },
    isListVisible() {
      return (
...
.simple-typeahead .simple-typeahead-list {
  ...
  max-height: 400px;
  overflow-y: auto;
  border-bottom: 0.1rem solid #ffcbcb;
  z-index: 9;
}
